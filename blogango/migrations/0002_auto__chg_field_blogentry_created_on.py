...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blogango_blogentry', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'BlogEntry.created_on'
        db.alter_column(u'blogango_blogentry', 'created_on', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'blogango.comment': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.User']", 'null': 'True', 'blank': 'True'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
